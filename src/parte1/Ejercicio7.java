...
public class Ejercicio7 {
	...
	public static void main(String[] args) {
		...
		/* Comprobamos si el numero es mayor que los numeros de 4,3,2,1 cifras, si el numero es mayor que alguno, este tendra 
		 una cifra mas, es decir que si el numero tiene menos que 5 cifras pero mas que 3 tendra 4 cifras.*/
